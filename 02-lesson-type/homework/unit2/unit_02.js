...
function t12() {
    let inp = document.querySelector('.i-12-1');
    let inp1 = document.querySelector('.i-12-2');
    let out = document.querySelector('.out-12');
    // out.innerHTML =  "Hello" + " " + inp.value + " " + inp1.value;
    out.innerHTML =  `Hello ${ inp.value} ${inp1.value}`;
}
...
function t16() {
    let inp = document.querySelector('.i-16-1');
    let inp1 = document.querySelector('.i-16-2');
    let out = document.querySelector('.out-16');
    out.innerHTML = +inp.value + +inp1.value;
}
...
function t17() {
    let inp = document.querySelector('.i-17').value;
...
function t19() {
    ...
    if (a < 0 && b < 0) {
        ...
        out.textContent = "Введите два отрицательных числа";
    }
}
